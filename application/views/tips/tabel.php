...
<!-- <div class="content-wrapper"> -->
	<div class="content-header">
		<div class="container">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Record Tips</h1>
				</div>
				<div class="col-sm-6">
				...
				<div class="col-12">
					...
					<table id="example2" class="table" width="100%">
						...
						<thead style="background-color: white;">
							<form action="<?= base_url("Match/input_tips") ?>" method="POST">
								<tr>
									...
									<td> <input style="border:none; border-bottom: solid; width: 140px;" list="data_mahasiswa" onchange="return autofill_anak();" class="form-control" type="input" name="nm_tips" id="nm_kry" placeholder="Nama" required></td>
						...
						<tbody style="text-align: center;">
							...
							foreach ($tips as $k): ?>
								<tr>
									...
									<td>
										<a href="<?= base_url('Match/edit_tips/').$k->id_tips; ?>"><div class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></div></a>
										<a onclick="return confirm('Yakin Hapus?')" href="<?= base_url('Match/drop_tips/').$k->id_tips; ?>"><div class="btn btn-danger btn-sm tombolhps" ><i class="fas fa-trash"></i></div></a>
									</td>
									<td><?= $k->admin ?></td>									
								</tr>
								<?php $i++; endforeach ?>
		...
		<!-- ======================================================== conten ======================================================= -->
		<form action="<?= base_url('Match/tips2'); ?>" method="post">
		...
		<form action="<?= base_url('Match/summary_tips'); ?>" method="post">
		...
		<form action="<?= base_url('Match/drop_tips_skala'); ?>" method="post">
