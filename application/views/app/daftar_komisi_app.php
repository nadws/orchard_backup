...
<!-- <div class="content-wrapper"> -->
	...
	<div class="content-header">
		<div class="container">
			...
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Daftar Komisi Appointment</h1>
				</div>
				<div class="col-sm-6">
		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<button data-toggle="modal" data-target="#modal-view" class="btn btn-success mb-2"><i class="fas fa-eye"></i> View</button>
							...
							<table id="example1" class="table">
								...
								<tbody>
									<?php foreach ($komisi as $key => $value): ?>
										<tr>
											<td><?= $key+1 ?></td>
                                            <td><a href="<?= base_url(); ?>Match/check_app?app=<?= $value->id_app; ?>"><?= $value->nm_kry ?></a></td>
                                            <td>Rp. <?= number_format($value->komisi) ?></td>
	...
	<form action="<?= base_url('Match/daftar_komisi_app'); ?>" method="post">
