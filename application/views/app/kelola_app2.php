      ...
      <div class="modal-content">
        ...
        <input type="hidden" name="tgl" value="<?= $tgl; ?>">
          ...
          <tr>
            ...
            <td class="" width="20%">
            <input type="time" class="form-control jam_mulai" name="jam_mulai" id="jam_mulai" required="">
            </td>
            <!-- <td></td> -->
          </tr>
          </table>
...
<div class="modal fade" id="myModal" role="dialog">
        <div class="modal-dialog">
          ...
          <!-- Modal content-->
          <form action="<?= base_url() ?>match/add_terapis_kelola2" method="post">
            <div class="modal-content">
              <div class="modal-header" style="background: #FFA07A;">
        ...
        success:function(data){
          ...
          if(data == "gagal"){
            Swal.fire({
                      ...
                      setTimeout("window.location.href='<?= base_url(); ?>match//kelola_app2?tgl=<?= $tgl; ?>'", 700);         
