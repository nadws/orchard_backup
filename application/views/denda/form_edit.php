...
<!-- <div class="content-wrapper"> -->
	<div class="content-header">
		<div class="container">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Form Edit Denda</h1>
				</div>
				<div class="col-sm-6">
				...
				<div class="col-12">
					<table class="table table-striped table-bordered" width="100%">
						...
						<thead style="background-color: white;">
							<form action="<?= base_url("Match/update_denda") ?>" method="POST">
								<tr>
									...
									<td> <input style="border:none; border-bottom: solid;" list="data_mahasiswa" onchange="return autofill_anak();" class="form-control" type="input" name="nm_denda" id="nm_kry" value="<?= $nm_denda ?>"></td>
						
									<td><input style="border:none; border-bottom: solid;" class="form-control" type="text" name="alasan" value="<?= $alasan ?>"></td>

									<td><input style="border:none; border-bottom: solid;" class="form-control" type="text" name="nominal" value="<?= $nominal ?>"></td>
