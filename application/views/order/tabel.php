											...
											<div class="row">
												...
												<div class="col-sm-4">
													<div class="form-group">
														...
														<select name="satuan" id="cart_satuan" class="form-control" required="">
												...
												<div class="col-sm-8">
													<div class="form-group">
														...
														<input type="text" id="cart_satuan" name="catatan" class="form-control" placeholder="Catatan Tambahan">
													</div>
												</div>
											</div>
										</div>
									...
									<div class="buying-selling-group" id="buying-selling-group" data-toggle="buttons">
										...
										<?php foreach ($karyawan as $key => $value): ?>
											...
											<label class="btn btn-default buying-selling">
												<input type="radio" name="id_karyawan" value="<?= $value->id_kry ?>" id="option1" autocomplete="off" class="cart_id_karyawan">
