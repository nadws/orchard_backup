...
<!-- <div class="content-wrapper"> -->
	...
	<div class="content-header">
		<div class="container">
			...
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Daftar Komisi Penjualan</h1>
				</div>
				<div class="col-sm-6">
							...
							<table id="example1" class="table">
								...
								<tbody>
									<?php foreach ($komisi as $key => $value): ?>
										<tr>
											<td><?= $key+1 ?></td>
                                            <td><a href="<?= base_url(); ?>Match/check_penjualan?id=<?= $value->id_pembelian; ?>"><?= $value->nm_kry ?></a></td>
	...
	<form action="<?= base_url('Match/daftar_komisi'); ?>" method="post">
