      ...
      <?= $this->session->flashdata('message'); ?>
				<div class="card">
                    <div class="card-header">
                       <h3 class="float-left">Detail Pengeluaran</h3>
                       ...
                       <button type="button" class="btn btn-sm btn-outline-secondary float-right ml-2" data-toggle="modal" data-target="#view-data"><i class="fa fa-eye"></i> Lihat Perperiode</button> -->
                        <a href="<?= base_url('Match/print_detail_pengeluaran') ?>?id=<?= $akun->id_akun ?>&tgl1=<?= $tgl1 ?>&tgl2=<?= $tgl2 ?>" class="btn btn-sm  btn-outline-secondary float-right ml-2"><i class="fas fa-print"></i> Print</a>
                       <a href="<?= base_url('Match/rekapitulasi_pengeluaran') ?>?tgl1=<?= $tgl1; ?>&tgl2=<?= $tgl2 ?>" class="btn btn-sm  btn-outline-secondary float-right ml-2"><i class="fas fa-arrow-left"></i></i> Kembali</a> 
