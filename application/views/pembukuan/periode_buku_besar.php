      ...
      <?= $this->session->flashdata('message'); ?>
				<div class="card">
                    <div class="card-header">
                       <h3 class="float-left">Buku Besar Periode <?= date('d/m/Y' , strtotime($tgl1)) ?> - <?= date('d/m/Y' , strtotime($tgl2)) ?></h3>
                       <a href="<?= base_url('Match/print_buku_besar_periode') ?>?id_akun=<?= $akun->id_akun ?>&tgl1=<?= $tgl1 ?>&tgl2=<?= $tgl2 ?>" class="btn btn-sm  btn-outline-secondary float-right ml-2"><i class="fas fa-print"></i> Print</a>
