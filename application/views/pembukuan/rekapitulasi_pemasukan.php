      ...
      <?= $this->session->flashdata('message'); ?>
				<div class="card">
                    <div class="card-header">
                       <h4 class="float-left">Rekapitulasi Jurnal Pengeluaran <?= $month ?> - <?= $year ?></h4>
                       <a href="<?= base_url('Match/jurnal') ?>?month=<?= $month; ?>&year=<?= $year ?>" class="btn btn-sm  btn-outline-secondary float-right ml-2"><i class="fas fa-arrow-left"></i></i> Kembali</a>
                    </div>
                        <?php $i=1; ?>
                        ...
                        <thead>
                            ...
                            ?>
                                <!-- <td><?= $i++ ?></td> -->
                                    ...
                                    <td><?= $b->no_akun ?></td>
                                    <td><a href="<?= base_url('Match/detail_pemasukan') ?>?id=<?= $b->id_akun ?>&month=<?= $month; ?>&year=<?= $year ?>"><?= $b->nm_akun ?></a></td>                                    
